...
# Add some new innodb page type in MySQL 8.0
# Other innodb page types reference: https://dev.mysql.com/doc/dev/mysql-server/latest/fil0fil_8h.html#a98d3fc7dcab858ee6f9981dca51089a7
innodb_page_type = {
